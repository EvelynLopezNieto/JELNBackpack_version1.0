...
public class Metodos_Miercoles {
...
//    public void guardarMiercoles(Estructura_Miercoles estMi) {
//        vPrincipal.addElement(estMi);
//    }

    //PARA GUARDAR EN UN archivo txt
    public void guardarArchivoMiercoles(Estructura_Miercoles estructuraMi) {
        try {
            FileWriter fw = new FileWriter(materiasMiercoles, true);
            BufferedWriter bw = new BufferedWriter(fw);
            PrintWriter pw = new PrintWriter(bw);
            pw.print(estructuraMi.getHora_miercoles());
            pw.print("|" + estructuraMi.getMateria_miercoles());
            pw.println();
            pw.close();
        } catch (Exception e) {
    ...
    public void borrarRegMatMi(){
        try {
           FileWriter fw = new FileWriter(materiasMiercoles);
    ...
    public DefaultTableModel listaMaterias() {
        ...
        try {
            FileReader fr = new FileReader(materiasMiercoles);
